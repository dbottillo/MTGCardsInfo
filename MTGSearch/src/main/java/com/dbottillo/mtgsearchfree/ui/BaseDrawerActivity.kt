...
abstract class BaseDrawerActivity: BasicActivity(), NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onNavigationItemSelected(menuItem: MenuItem): Boolean {
        ...
        } else if (menuItem.itemId == R.id.drawer_saved && currentFragment !is OldSavedFragment) {
            changeFragment(OldSavedFragment(), "saved_fragment", true)
        ...
        } else if (menuItem.itemId == R.id.drawer_decks && currentFragment !is OldDecksFragment) {
            changeFragment(OldDecksFragment(), "decks", true)
